...
def salvar_imagem(imagem):
    ...
    #definir caminho da pasta para salvamento
...
def editar_perfil():
    ...
    elif request.method == 'GET': #preencher os campos automaticamente
...
@app.route('/post/<post_id>', methods=['GET', 'POST']) #<> indica variável.
@login_required
